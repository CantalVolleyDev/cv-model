...
public class Gym {
	@DAOTableField(id = true, autoGenerated = true, name = "idegym", required = true, type = DBType.INTEGER)
	private Integer identifier;
	@DAOTableField(name = "libgym", length = 40, required = true, type = DBType.VARCHAR)
